  ...
  return (
    <section id="projects" className="w-full h-full mt-40 mb-10">
      <div className="w-full h-full flex flex-col items-center justify-center pt-20">
        <h1 className="text-4xl text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-500">Projects</h1>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mt-10 place-items-center">
          ...
          >
            ...
            <div className="flex flex-row bg-neutral h-[80px] rounded-b-xl items-center justify-end px-2 w-full">
          ...
          <motion.div
            ...
            className="w-[350px] lg:w-[500px] h-[300px] rounded-xl flex flex-col z-10 place-items-center"
          >
